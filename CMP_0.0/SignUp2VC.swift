...
class SignUp2VC: UIViewController {
    ...
    func signUp(){
        ...
        newUser.setObject("0", forKey: "mealsLeft")
        ...
        newUser.signUpInBackgroundWithBlock({ (succeed, error) -> Void in
            ...
            if ((error) != nil) {
                ...
                let createInstanceInPendingTransaction = PFObject(className: "pendingTransaction")
                createInstanceInPendingTransaction["userid"] = newUser.objectId
                createInstanceInPendingTransaction["transactionid"] = ""
                
                createInstanceInPendingTransaction.saveInBackground()
                ...
                let signupSuccessAction = UIAlertAction(title: "OK", style: UIAlertActionStyle.Default) {
                    ...
                    print(createInstanceInPendingTransaction.objectId)
                    newUser.setObject(createInstanceInPendingTransaction.objectId!, forKey: "pendingTransactionId")
